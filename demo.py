...
def log_info(str_message):
	now = datetime.datetime.now()
	print bcolors.OKBLUE + '['+str(now.hour)+':'+ str(now.minute)+':'+str(now.second)+'][INF]\t'+ str_message + bcolors.ENDC
	sys.stdout.flush()

def log_error(str_message):
	now = datetime.datetime.now()
	print bcolors.FAIL + '['+str(now.hour)+':'+ str(now.minute)+':'+str(now.second)+'][ERR]\t'+ str_message + bcolors.ENDC
	sys.stdout.flush()

def log_ok(str_message):
	now = datetime.datetime.now()
	print bcolors.OKGREEN + '['+str(now.hour)+':'+ str(now.minute)+':'+str(now.second)+'][OK]\t'+ str_message + bcolors.ENDC
	sys.stdout.flush()
def end():
	print '\n'
	log('Exiting...')
